...
| ---------------------------------- | -------------- | ------------- | --------------- | --------- | ----------------------------------------------------------- | ---------------------------------------- | ---------------------------------------------------------------------- |
| WooCommerce                        | 10.9.4         | 16-07-2026    | Woo             | supported | shop, cart, checkout, account, Sobe WooCommerce blocks      | Core commerce dependency of this platform | [link](https://en-gb.wordpress.org/plugins/woocommerce/)               |
