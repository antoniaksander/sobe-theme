...
- Treat merge conflicts as expected sync work, not as an error. Both platform and client repos commonly touch `.gitignore`, `resources/css/tokens.css`, `resources/blocks/blocks-manifest.json`, `app/blocks.php`, and client-adjusted tests.
