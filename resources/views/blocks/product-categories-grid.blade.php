@php
  ...
  $categories = apply_filters('sobe/product_categories_grid/categories', $categories, $attributes);
  ...
  $view = apply_filters('sobe/product_categories_grid/view', '', $categories, $attributes);
@endphp

@if($view)
  @include($view, ['categories' => $categories, 'attributes' => $attributes])
@else
