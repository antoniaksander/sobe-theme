  ...
  <div class="sobe-overlay__panel">
    <div class="sobe-overlay__input-row">
      <input
        ...
        placeholder="{{ __('Search products…', 'sobe') }}"
        ...
        >
          <a :href="result.url">
            ...
            <div class="sobe-overlay__result-meta">
              ...
              <span class="sobe-overlay__result-price" x-html="result.price_html"></span>
            </div>
          </a>
        </li>
      </template>
    ...
    >
      {{ __('No products found.', 'sobe') }}
    </p>

    <a
      x-show="results.length > 0"
      :href="`${searchPageUrl}?s=${encodeURIComponent(query)}&post_type=product`"
